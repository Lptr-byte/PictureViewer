...
#define ICON_IGFD_MARKDOWN u8"\uf48a"
#define ICON_IGFD_CPP u8"\ufb71"
#define ICON_IGFD_C u8"\ufb70"
#define ICON_IGFD_HEADFILE u8"\ufd27"
#define ICON_IGFD_HPP u8"\uf773"
#define ICON_IGFD_SETTINGS u8"\uf992"